...
xtop_rec_elect_fullnode_contract::xtop_rec_elect_fullnode_contract(common::xnetwork_id_t const & network_id) : xbase_t{network_id} {}
...
void xtop_rec_elect_fullnode_contract::elect_config_nodes(common::xlogic_time_t const current_time) {
...
void xtop_rec_elect_fullnode_contract::setup() {
...
void xtop_rec_elect_fullnode_contract::on_timer(const uint64_t current_time) {
#ifdef STATIC_CONSENSUS
...
#    endif
    ...
    XCONTRACT_ENSURE(SELF_ADDRESS().value() == sys_contract_rec_elect_fullnode_addr,
...
common::xnode_type_t xtop_rec_elect_fullnode_contract::standby_type(common::xzone_id_t const & zid, common::xcluster_id_t const & cid, common::xgroup_id_t const & gid) const {
