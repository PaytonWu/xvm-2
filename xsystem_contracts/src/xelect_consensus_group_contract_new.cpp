...
bool xtop_elect_consensus_group_contract_new::elect_group(common::xzone_id_t const & zid,
...
void xtop_elect_consensus_group_contract_new::handle_elected_out_data(std::vector<common::xfts_merkle_tree_t<common::xnode_id_t>::value_type> const & chosen_out,
...
void xtop_elect_consensus_group_contract_new::handle_elected_in_data(std::vector<common::xfts_merkle_tree_t<common::xnode_id_t>::value_type> const & chosen_in,
    ...
    for (auto const & in : chosen_in) {
        ...
        auto const elect_in_pos = std::find_if(
            std::begin(effective_standby_data), std::end(effective_standby_data), [&node_id](xelection_awared_data_t const & other) { return other.account() == node_id; });
...
bool xtop_elect_consensus_group_contract_new::do_normal_election(common::xzone_id_t const & zid,
                                                                 common::xcluster_id_t const & cid,
                                                                 common::xgroup_id_t const & gid,
                                                                 common::xnode_type_t const node_type,
...
bool xtop_elect_consensus_group_contract_new::do_shrink_election(common::xzone_id_t const & zid,
                                                                 common::xcluster_id_t const & cid,
                                                                 common::xgroup_id_t const & gid,
                                                                 common::xnode_type_t const node_type,
                                                                 std::uint64_t const random_seed,
