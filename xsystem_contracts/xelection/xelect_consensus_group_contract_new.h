...
class xtop_elect_consensus_group_contract_new : public xelect_group_contract_new_t {
public:
    xtop_elect_consensus_group_contract_new(xtop_elect_consensus_group_contract_new const &) = delete;
    xtop_elect_consensus_group_contract_new & operator=(xtop_elect_consensus_group_contract_new const &) = delete;
    xtop_elect_consensus_group_contract_new(xtop_elect_consensus_group_contract_new &&) = default;
    xtop_elect_consensus_group_contract_new & operator=(xtop_elect_consensus_group_contract_new &&) = default;
    ~xtop_elect_consensus_group_contract_new() override = default;

protected:
    xtop_elect_consensus_group_contract_new() = default;
...
using xelect_consensus_group_contract_new_t = xtop_elect_consensus_group_contract_new;
